...
/// The category this budget caps. One budget per category per [period].
 int get categoryId;/// The month this budget applies to, as 'YYYY-MM' (see `periodKey`).
 ...
 int? get id; int get createdAt;/// Derived, non-persisted expense total for this category+period, populated
...
@override
String toString() {
  return 'Budget(categoryId: $categoryId, period: $period, limitAmount: $limitAmount, id: $id, createdAt: $createdAt, spent: $spent)';
}
...
class _Budget implements Budget {
  const _Budget({required this.categoryId, required this.period, required this.limitAmount, this.id, this.createdAt = 0, this.spent = 0});
