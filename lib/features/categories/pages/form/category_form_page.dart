...
class _CategoryFormPageState extends State<CategoryFormPage> {
          ...
          child: AppScaffold(
            ...
            body: ListView(
              ...
              children: [
                ...
                FieldLabel(s.categoryName),
                TextField(
                  controller: _nameController,
                  onChanged: cubit.nameChanged,
                  textCapitalization: TextCapitalization.words,
                  decoration: appInputDecoration(context, hint: s.categoryName),
                ),
                const SizedBox(height: AppSpacing.xl),
                FieldLabel(s.parentCategory),
                SelectorField(
  ...
  Future<void> _pickParent(BuildContext context) async {
    final cubit = context.read<CategoryFormCubit>();
    final s = Strings.of(context)!;
    // D4: the current selection is now shown with a check (was a plain ListTile
    // sheet with no selected state), reusing the settings SettingOptionTile.
