...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( Failure failure)?  failure,TResult Function()?  success,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LogoutStateLoading() when loading != null:
return loading();case LogoutStateFailure() when failure != null:
return failure(_that.failure);case LogoutStateSuccess() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( Failure failure)  failure,required TResult Function()  success,}) {final _that = this;
switch (_that) {
case LogoutStateLoading():
return loading();case LogoutStateFailure():
return failure(_that.failure);case LogoutStateSuccess():
return success();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( Failure failure)?  failure,TResult? Function()?  success,}) {final _that = this;
switch (_that) {
case LogoutStateLoading() when loading != null:
return loading();case LogoutStateFailure() when failure != null:
return failure(_that.failure);case LogoutStateSuccess() when success != null:
...
class LogoutStateFailure implements LogoutState {
  const LogoutStateFailure(this.failure);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LogoutStateFailure&&(identical(other.failure, failure) || other.failure == failure));
}
