...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( Failure failure)?  failure,TResult Function( AuthUser? data)?  success,required TResult orElse(),}) {final _that = this;
switch (_that) {
case UserStateLoading() when loading != null:
return loading();case UserStateFailure() when failure != null:
return failure(_that.failure);case UserStateSuccess() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( Failure failure)  failure,required TResult Function( AuthUser? data)  success,}) {final _that = this;
switch (_that) {
case UserStateLoading():
return loading();case UserStateFailure():
return failure(_that.failure);case UserStateSuccess():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( Failure failure)?  failure,TResult? Function( AuthUser? data)?  success,}) {final _that = this;
switch (_that) {
case UserStateLoading() when loading != null:
return loading();case UserStateFailure() when failure != null:
return failure(_that.failure);case UserStateSuccess() when success != null:
...
$AuthUserCopyWith<$Res>? get data {
  ...
  return $AuthUserCopyWith<$Res>(_self.data!, (value) {
